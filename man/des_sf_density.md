Flux per unit of surface. A volume of fluid that is passing across a given area of sapwood per unit of time. Expressed as cm³ (volume of sap) per cm² (area of sapwood) per second, minute or hour (time).
